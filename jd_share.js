/* 
活动名称：分享有礼
活动链接：https://lzkjdz-isv.isvjcloud.com/wxShareActivity/activity/<activityId>?activityId=<activityId>
环境变量：SHARE_ACTIVITY_ID // 活动ID
        OWN_COOKIE_NUM // 需要助力的数量
...
if (process.env.OWN_COOKIE_NUM && process.env.OWN_COOKIE_NUM != "") {
