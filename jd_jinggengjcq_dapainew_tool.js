...
async function bindWithVender(venderId) {
    ...
    let h5st = await h5stSign(bodyStr) || 'undefined'
    let opt = {
        url: `https://api.m.jd.com/client.action?appid=jd_shop_member&functionId=bindWithVender&body=${encodeURIComponent(bodyStr)}&client=H5&clientVersion=9.2.0&uuid=88888&h5st=${h5st}`,
        headers: {
            Host: 'api.m.jd.com',
            Accept: '*/*',
            Connection: 'keep-alive',
